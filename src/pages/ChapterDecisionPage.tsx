  ...
  return (
    <div className="absolute inset-0 overflow-y-auto">
      <div className="min-h-full flex flex-col p-4 pt-6 md:p-8 md:pt-8 pb-24">
        ...
        >
          <div className="font-mono text-[8px] tracking-[0.4em] uppercase mb-2" style={{ color: 'rgba(245,158,11,0.7)' }}>
          ...
          <p className="font-mono text-[9px] tracking-widest mt-1" style={{ color: 'rgba(148,163,184,0.6)' }}>
            {data.subtitle}
          </p>
        </motion.div>
        ...
        >
          {data.effects.map((effect, i) => (
            ...
            >
              <div className="font-mono text-[9px] tracking-widest mb-1.5 font-bold"
        ...
        >
          <div className="font-mono text-[8px] tracking-[0.3em] uppercase mb-2" style={{ color: 'rgba(220,38,38,0.7)' }}>
            Beijing Response
          </div>
          <p className="font-ui text-[11px] leading-relaxed italic" style={{ color: '#94a3b8' }}>
          ...
          {data.characters.map((char) => (
            <div key={char.characterId} className="relative rounded-sm overflow-hidden" style={{ minHeight: '220px' }}>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <p className="font-serif text-[11px] leading-relaxed mb-2 text-shadow" style={{ color: '#cbd5e1' }}>
                  {char.story}
                </p>
                <p className="font-serif italic text-[10px] text-shadow" style={{ color: 'rgba(148,163,184,0.7)' }}>
                  "{char.dialogue}"
                </p>
              </div>
            </div>
    ...
    <div className="absolute inset-0 overflow-y-auto">
      <div className="min-h-full flex flex-col p-4 pt-6 md:p-8 md:pt-8 pb-24 max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          transition={{ duration: shouldReduce ? 0 : 0.5, delay: shouldReduce ? 0 : 0.15 }}
        >
          <p className="font-serif text-sm leading-[1.85]" style={{ color: '#cbd5e1' }}>
        ...
        >
          <div className="font-mono text-[8px] tracking-[0.3em] uppercase mb-2" style={{ color: 'rgba(148,163,184,0.45)' }}>
            Strategic Impact
          </div>
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
      <motion.div
        ...
        className="max-w-lg"
      >
        <div className="font-mono text-[8px] tracking-[0.5em] uppercase mb-4" style={{ color: 'rgba(148,163,184,0.45)' }}>
        ...
        <p className="font-serif text-sm leading-relaxed mb-8" style={{ color: '#94a3b8' }}>
          {isLast
        ...
        <div className="flex-1 grid md:grid-cols-3 gap-4">
          ...
          >
            <div className="glass-panel rounded-sm p-4" style={{ borderLeft: `2px solid ${color}50` }}>
              <div className="font-mono text-[8px] tracking-[0.3em] uppercase mb-2 font-bold"
                style={{ color: `${color}80` }}>
                Situation
              </div>
              <p className="font-ui text-[11px] leading-relaxed" style={{ color: '#94a3b8', whiteSpace: 'pre-line' }}>
                {decision.context}
              </p>
            </div>
            <div className="glass-panel rounded-sm p-4" style={{ borderLeft: '2px solid rgba(245,158,11,0.35)' }}>
              ...
              <p className="font-serif italic text-[11px] leading-relaxed" style={{ color: '#94a3b8' }}>
                {decision.question}
              </p>
            </div>
          </motion.div>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-ui font-bold text-sm mb-1.5"
                      ...
                      <div className="flex items-start gap-1.5">
                        <span className="font-mono text-[8px] tracking-widest uppercase mt-0.5 flex-shrink-0"
                          style={{ color: 'rgba(248,113,113,0.55)' }}>
                          RISK:
                        </span>
                        <span className="font-ui text-[10px] leading-snug"
                          style={{ color: 'rgba(248,113,113,0.55)' }}>
                          {choice.risk}
                        </span>
                      </div>
...
function ChapterIntroPanel({ chapter, onStart, onBack }: { chapter: typeof CHAPTERS[0]; onStart: () => void; onBack: () => void }) {
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
      ...
      >
        <div className="font-mono text-[8px] tracking-[0.5em] uppercase mb-4" style={{ color: 'rgba(148,163,184,0.4)' }}>
          Chapter {chapter.number}
        </div>
        <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.6rem,3.5vw,2.4rem)', fontWeight: 700, color: '#f1f5f9', marginBottom: '0.5rem' }}>
          {chapter.name}
        </h2>
        <div className="font-mono text-[9px] tracking-[0.3em] uppercase mb-5" style={{ color: 'rgba(148,163,184,0.5)' }}>
          {chapter.subtitle}
        </div>
        <p className="font-serif text-sm leading-relaxed mb-6" style={{ color: '#94a3b8' }}>
          {chapter.description}
        </p>
        <div className="mb-5 glass-panel rounded-sm px-4 py-3 inline-block">
          <span className="font-mono text-[9px] tracking-widest uppercase" style={{ color: 'rgba(148,163,184,0.45)' }}>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <button
            onClick={onStart}
            className="font-ui font-semibold text-xs tracking-[0.2em] uppercase px-6 py-3 rounded-sm"
            style={{ background: 'rgba(59,130,246,0.12)', border: '1px solid rgba(59,130,246,0.4)', color: '#93c5fd' }}
          >
            Begin Chapter →
          </button>
...
export default function ChapterDecisionPage({ chapterIndex }: { chapterIndex: number }) {
  ...
  const handleChapterComplete = () => {
    const nextChapterPage = 4 + chapterIndex + 1; // page 4 = chapter0, page 5 = chapter1, etc.
    if (isLastChapter) {
      navigate(8); // ending
    } else {
  ...
  const handleBack = () => {
    if (innerPhase === 'consequence') {
      ...
      navigate(chapterIndex === 0 ? 3 : 3 + chapterIndex); // back to previous page
